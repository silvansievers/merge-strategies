...
public:
    ...
    */
    ...
    bool operator==(const LocalLabelInfo &other) const;
};
...
public:
    ...
    */
    ...
    int get_group_id_for_label(int label_no) const {
        return label_to_local_label[label_no];
    }

    const LocalLabelInfo &get_local_label_info(int local_label) const {
        return local_label_infos[local_label];
    }
