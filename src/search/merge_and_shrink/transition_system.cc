...
bool LocalLabelInfo::operator==(const LocalLabelInfo &other) const {
...
bool TransitionSystem::operator==(const TransitionSystem &other) const {
    ...
    assert(label_to_local_label == other.label_to_local_label);
    assert(local_label_infos == other.local_label_infos);
