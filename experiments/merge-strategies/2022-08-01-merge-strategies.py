...
exp.add_absolute_report_step(
    filter_algorithm=[
        '{}-b50k-cggl-time900'.format(REVISION),
        '{}-b50k-dfp-time900'.format(REVISION),
        '{}-b50k-miasm-dfp-time900'.format(REVISION),
        '{}-b50k-rl-time900'.format(REVISION),
        '{}-b50k-sbmiasm-time900'.format(REVISION),
        '{}-b50k-sccdfp-time900'.format(REVISION),
        '{}-b50k-sbcollection-time900'.format(REVISION),
    ],
...
exp.add_fetcher(
    'data/2021-03-18-merge-strategies-eval',
    filter_algorithm=[
        '{}-b50k-cggl-partialmax-time900'.format(OLD_REVISION),
        '{}-b50k-dfp-partialmax-time900'.format(OLD_REVISION),
        '{}-b50k-miasm-dfp-partialmax-time900'.format(OLD_REVISION),
        '{}-b50k-rl-partialmax-time900'.format(OLD_REVISION),
        '{}-b50k-sbmiasm-partialmax-time900'.format(OLD_REVISION),
        '{}-b50k-sccdfp-partialmax-time900'.format(OLD_REVISION),
        '{}-b50k-sbcollection-partialmax-time900'.format(OLD_REVISION),
    ],
    merge=True
)
...
exp.add_fetcher(
    ...
    filter_algorithm=[
        ...
        '{}-b50k-miasm-dfp-time900'.format(MIDDLE_REV),
        '{}-b50k-rl-time900'.format(MIDDLE_REV),
        '{}-b50k-sbmiasm-time900'.format(MIDDLE_REV),
        '{}-b50k-sccdfp-time900'.format(MIDDLE_REV),
        '{}-b50k-sbcollection-time900'.format(MIDDLE_REV),
    ],
    merge=True
)
