...
exp.add_absolute_report_step(
    filter_algorithm=[
        '{}-b50k-cggl-largest-nonlinear-b60-partialmax-time900'.format(REVISION),
        '{}-b50k-dfp-largest-nonlinear-b60-partialmax-time900'.format(REVISION),
        '{}-b50k-miasm-dfp-largest-nonlinear-b60-partialmax-time900'.format(REVISION),
        '{}-b50k-rl-largest-nonlinear-b60-partialmax-time900'.format(REVISION),
        '{}-b50k-sccdfp-largest-nonlinear-b60-partialmax-time900'.format(REVISION),
        '{}-b50k-sbmiasm-largest-nonlinear-b60-partialmax-time900'.format(REVISION),
    ],
    attributes=attributes,
)

OLD_REVISION='e5c199c9868b04782a6c8c2af85906ef55007673'
exp.add_fetcher(
    'data/2021-03-17-symmetries-eval',
    filter_algorithm=[
        ...
        '{}-b50k-sccdfp-largest-nonlinear-b60-partialmax-time900'.format(OLD_REVISION),
